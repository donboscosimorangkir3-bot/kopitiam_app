...
class AuthRemoteDatasource {
  ...
  Future<bool> verifyOtp(String email, String otp) async {
    try {
      ...
      print("Gagal Verifikasi: ${e.response?.data}");
      return false;
    }
  }

  // LOGIN (Gue tambahin dikit biar tau kalau butuh verifikasi)
  Future<dynamic> login(String email, String password) async {
    try {
      ...
      // Jika status 403, kita return string "NEED_VERIFY" biar UI tau harus pindah ke OtpPage
      if (e.response?.statusCode == 403) return "NEED_VERIFY";
      return false;
    }
  }

  // ... (Fungsi lain: getUserInfo, updateProfile, dll biarkan tetap ada di bawahnya)
